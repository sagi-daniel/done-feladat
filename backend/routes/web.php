...
Route::prefix('api')->group(function () {
    ...
    Route::get('classes/all', [ClassController::class, 'allclass'])->name('classes.allclass');
    ...
    Route::get('students/{id}/all', [StudentController::class, 'allstudents'])->name('students.allstudents');
